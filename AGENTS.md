...
## Links
- [Repository Name](https://github.com/...) - Importer implementation in external repository
...
- **Links**: External importer implementations in other repositories (e.g., electricityMaps, gridstatus.io). Do NOT include the main repository links here.
...
**Do NOT include:**
- Implementation details (code snippets, function names, class names)
- Environment variable names or configuration
- Source code repository links
- Parser/importer-specific logic
...
### Important Notes
1. **Verify Source Code**: Before adding links to external repositories, verify the code implements the endpoints we're documenting (not just that files exist)
